...
import { splitVersion, isVersionUnsupportedBelow } from '../common.js';
...
describe('minimumRequirement', () => {
	const combinationsMinimumRequirement = /** @type {const} */ ([
		...
		{ version: /** @type {undefined} */ (undefined), below: '18.3', expected: undefined },
