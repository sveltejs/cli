import { css, defineAddon, defineAddonOptions, js, parse, svelte } from '../../core.js';
...
export default defineAddon({
	...
	run: ({ sv, options, files, kit, dependencyVersion, language }) => {
		...
		for (const plugin of plugins) {
			if (!options.plugins.includes(/** @type {'typography' | 'forms'} */ (plugin.id))) continue;
