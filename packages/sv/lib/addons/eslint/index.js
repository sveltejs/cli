...
import { defineAddon, getNodeTypesVersion, js, log, parse } from '../../core.js';
import { addEslintConfigPrettier } from '../../coreInternal.js';
...
export default defineAddon({
	...
	run: ({ sv, language, dependencyVersion, files }) => {
		...
		sv.file(files.eslintConfig, (content) => {
			...
			/** @type {Array<AstTypes.Expression | AstTypes.SpreadElement>} */
			const eslintConfigs = [];
			...
			/** @type {AstTypes.ArrayExpression | AstTypes.CallExpression} */
