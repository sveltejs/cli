import { defineAddon, defineAddonOptions, log, parse, color } from '../../core.js';
import { getSharedFiles } from '../../coreInternal.js';

const options = defineAddonOptions()
	.add('ide', {
		question: 'Which client would you like to use?',
		type: 'multiselect',
		/** @type {Array<'claude-code' | 'cursor' | 'gemini' | 'opencode' | 'vscode' | 'other'>} */
		default: [],
		options: [
