...
const MOVED_EXPORTS = new Map<string, string>([
	...
	['RemoteCommand', '@sveltejs/kit/remote'],
	['RemoteForm', '@sveltejs/kit/remote'],
	['RemoteFormEnhanceCallback', '@sveltejs/kit/remote'],
	['RemoteFormEnhanceInstance', '@sveltejs/kit/remote'],
	['RemoteFormField', '@sveltejs/kit/remote'],
	['RemoteFormFields', '@sveltejs/kit/remote'],
	['RemoteFormFieldType', '@sveltejs/kit/remote'],
	['RemoteFormFieldValue', '@sveltejs/kit/remote'],
	['RemoteFormInput', '@sveltejs/kit/remote'],
	['RemoteFormIssue', '@sveltejs/kit/remote'],
	['RemoteLiveQuery', '@sveltejs/kit/remote'],
	['RemoteLiveQueryFunction', '@sveltejs/kit/remote'],
	['RemotePrerenderFunction', '@sveltejs/kit/remote'],
	['RemoteQuery', '@sveltejs/kit/remote'],
	['RemoteQueryFunction', '@sveltejs/kit/remote'],
	['RemoteQueryOverride', '@sveltejs/kit/remote'],
	['RemoteQueryUpdate', '@sveltejs/kit/remote'],
	['RemoteResource', '@sveltejs/kit/remote'],
	['isValidationError', '@sveltejs/kit/remote'],
	['ValidationError', '@sveltejs/kit/remote'],
	['RequestedEntry', '@sveltejs/kit/remote'],
	['LiveRequestedEntry', '@sveltejs/kit/remote'],
