...
```ts
// Identical to `sv`, see its api-surface: Addon, AddonById, AddonMap, BaseQuestion, BooleanQuestion, FileEdit, FileEditMultiple, MaybePromise, MultiSelectQuestion, NoOptions, NumberQuestion, OfficialAddonOptions, OptionDefinition, OptionMap, OptionValues, Question, SelectQuestion, SetupOptions, StringQuestion, SvApi, Workspace, WorkspaceOptions
