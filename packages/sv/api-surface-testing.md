...
```ts
// Identical to `sv`, see its api-surface: Addon, AddonById, AddonMap, BaseQuestion, BooleanQuestion, FileEdit, FileEditMultiple, MaybePromise, MultiSelectQuestion, NumberQuestion, OfficialAddons, OptionDefinition, OptionMap, OptionValues, Question, SelectQuestion, SetupOptions, StringQuestion, SvApi, Workspace, WorkspaceOptions, officialAddons
