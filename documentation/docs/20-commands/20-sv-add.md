...
<!-- [API docs](/docs/cli/add-on) -->

Then you can continue with the LINK to start building your add-on. You can also have a look at the [official addons source code](https://github.com/sveltejs/cli/tree/feat/community-add-on-draft-0/packages/sv/lib/addons) to get some inspiration on what can be done.
